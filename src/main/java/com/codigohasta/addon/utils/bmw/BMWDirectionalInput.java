...
public class BMWDirectionalInput {
   ...
   public boolean isMoving() {
      return this.forwards && !this.backwards || this.backwards && !this.forwards || this.left && !this.right || this.right && !this.left;
   }

   public static BMWDirectionalInput fromPlayer() {
      MinecraftClient mc = MinecraftClient.getInstance();
      return mc.player == null ? NONE : new BMWDirectionalInput(mc.player.input.playerInput);
   }
}
