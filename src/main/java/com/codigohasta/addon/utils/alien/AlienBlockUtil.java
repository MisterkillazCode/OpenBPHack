...
public class AlienBlockUtil {
   ...
   public static boolean canPlace(BlockPos pos, double distance) {
      return getPlaceSide(pos, distance) == null ? false : canReplace(pos) && !hasEntity(pos, false);
   }
   ...
   public static void placeCrystal(BlockPos pos, boolean rotate) {
      ...
      Vec3d vec = obsPos.toCenterPos()
         .add(facing.getVector().getX() * 0.5, facing.getVector().getY() * 0.5, facing.getVector().getZ() * 0.5);
